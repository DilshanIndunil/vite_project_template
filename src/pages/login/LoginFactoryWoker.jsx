...
import { sendOTP, loginFactoryWorker } from "../../api/apiService.js"; // Assuming you have sendOTP and loginFactoryWorker in apiService
...
function LoginPage() {
    ...
    const handleSendVerificationCode = async () => {
        try {
            ...
            // Indicate that the verification code has been sent
            setIsCodeSent(true);
        } catch (error) {
    ...
    const handleLogin = async () => {
        try {
            // Call the login API
            const response = await loginFactoryWorker(phoneNumber, verificationCode);
            ...
            navigate("/asset-details-worker"); // Change this to your desired route
        } catch (error) {
